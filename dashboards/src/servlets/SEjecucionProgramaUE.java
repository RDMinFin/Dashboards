 ...
 */
@WebServlet("/SEjecucionProgramaUE")
public class SEjecucionProgramaUE extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.compareTo("entidadesData")==0){
			...
			switch(level){
				...
				case 3: entidades = CEjecucionDAO.getEntidadesProgramasEjecucion(entidad,unidad_ejecutora,mes,fuentes,"1,2,3,4",grupos, todosgrupos); break;
				case 4: entidades = CEjecucionDAO.getProgramasSubprogramasEjecucion(entidad,unidad_ejecutora,programa, mes,fuentes, "1,2,3,4",grupos, todosgrupos); break;
				case 5: entidades = CEjecucionDAO.getSubprogramasProyectosEjecucion(entidad,unidad_ejecutora,programa,subprograma, mes,fuentes, "1,2,3,4",grupos, todosgrupos); break;
				case 6: entidades = CEjecucionDAO.getProyectosActividadesObrasEjecucion(entidad,unidad_ejecutora,programa,subprograma,proyecto, mes,fuentes, "1,2,3,4",grupos, todosgrupos); break;
				case 7: entidades = CEjecucionDAO.getActividadesOBrasRenglonEjecucion(entidad,unidad_ejecutora,programa,subprograma,proyecto,actividad_obra, mes, ano,fuentes, "1,2,3,4",grupos); break;
			}
			...
			if(entidades!=null && entidades.size()>0){
				...
				if(map.get("excel")==null){
					...
					if (map.get("excel").compareTo("1")==0){						
						excel = new CExcel("Ejecucion_Programa",level==7);
